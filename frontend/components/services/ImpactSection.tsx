...
export default function ImpactSection({ impacts }: ImpactSectionProps) {
  const mappedImpacts = impacts.map((item) => ({
    ...item,
    logo: item.logo || '/default-image.png',
  }));

  return (
    <section className="relative py-24 px-6 bg-transparent overflow-hidden" id="impact">

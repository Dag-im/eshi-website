...
import { useSubmitContact } from '@/lib/api/useContact';
...
export default function ContactPageClient() {
  ...
  return (
    <main className="min-h-screen bg-green-50/50 text-rangitoto">
      <Particles
              ...
              <CardContent className="p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full rounded-full bg-rangitoto text-albescent-white hover:bg-avocado transition-all duration-300 py-6 shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 focus-visible:ring-2 focus-visible:ring-avocado"
                  >
                    {isSubmitting ? (
                      <>
